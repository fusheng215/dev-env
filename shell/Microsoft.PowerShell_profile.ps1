# ============================================================
#  PowerShell 7 profile  ($PROFILE)  鈥?dev-env
...
Write-Host "dev-env ready (PowerShell) 鈥?Node $(node -v 2>$null), Python $(python -V 2>&1 | Select-Object -Last 1)" -ForegroundColor Cyan
